      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="glass border-white/10">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-indigo-950/40 font-medium">Total Users</p>
        ...
        <Card className="glass border-white/10">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-indigo-950/40 font-medium">Total Jobs</p>
        ...
        <Card className="glass border-white/10">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-indigo-950/40 font-medium">Premium Users</p>
            ...
            <Card key={req.id} className="glass border-white/10">
              <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-indigo-950/40">Requested: {new Date(req.created_at).toLocaleString()}</p>
                  <a 
                    href={req.proof_url} 
                    target="_blank" 
